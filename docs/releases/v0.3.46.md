# Zeta Compiler v0.3.46 - Machine Learning Integration: AI/ML Support
...
Machine Learning Integration: AI/ML Support
...
This release maintains full backward compatibility with v0.3.45. No breaking changes were introduced.
