# Zeta Compiler v0.3.32 - Optimization Pipeline: Performance Excellence
...
Optimization Pipeline: Performance Excellence
...
This release maintains full backward compatibility with v0.3.31. No breaking changes were introduced.
