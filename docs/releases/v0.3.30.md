# Zeta Compiler v0.3.30 - Parser Foundation: Robust Syntax Analysis
...
Parser Foundation: Robust Syntax Analysis
...
This release maintains full backward compatibility with v0.3.29. No breaking changes were introduced.
