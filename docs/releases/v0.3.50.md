# Zeta Compiler v0.3.50 - Blockchain Extension: Multi-Chain Support
**Release Date:** 2026-03-33
...
Blockchain Extension: Multi-Chain Support
...
This release maintains full backward compatibility with v0.3.49. No breaking changes were introduced.
