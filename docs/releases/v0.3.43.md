# Zeta Compiler v0.3.43 - Advanced Type System: Cutting-Edge Features
...
Advanced Type System: Cutting-Edge Features
...
This release maintains full backward compatibility with v0.3.42. No breaking changes were introduced.
