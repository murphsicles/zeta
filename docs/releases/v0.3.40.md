# Zeta Compiler v0.3.40 - Standard Library: Foundation for Excellence
...
Standard Library: Foundation for Excellence
...
This release maintains full backward compatibility with v0.3.39. No breaking changes were introduced.
