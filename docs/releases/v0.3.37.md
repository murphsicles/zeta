# Zeta Compiler v0.3.37 - Metaprogramming Foundation: Code Generation
...
Metaprogramming Foundation: Code Generation
...
This release maintains full backward compatibility with v0.3.36. No breaking changes were introduced.
