# Zeta Compiler v0.3.47 - Formal Verification: Mathematical Correctness
...
This release maintains full backward compatibility with v0.3.46. No breaking changes were introduced.
