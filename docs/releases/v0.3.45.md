# Zeta Compiler v0.3.45 - Advanced Metaprogramming: Code Transformation
...
Advanced Metaprogramming: Code Transformation
...
This release maintains full backward compatibility with v0.3.44. No breaking changes were introduced.
