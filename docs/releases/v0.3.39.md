# Zeta Compiler v0.3.39 - Memory Management: Safety & Performance
...
Memory Management: Safety & Performance
...
This release maintains full backward compatibility with v0.3.38. No breaking changes were introduced.
