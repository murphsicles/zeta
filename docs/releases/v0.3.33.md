# Zeta Compiler v0.3.33 - Testing Framework: Quality Assurance
...
This release maintains full backward compatibility with v0.3.32. No breaking changes were introduced.
