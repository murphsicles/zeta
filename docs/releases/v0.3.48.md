# Zeta Compiler v0.3.48 - Quantum Computing: Hybrid Classical-Quantum
...
This release maintains full backward compatibility with v0.3.47. No breaking changes were introduced.
