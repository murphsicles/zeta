# Zeta Compiler v0.3.35 - Tooling Foundation: Developer Experience
...
Tooling Foundation: Developer Experience
...
This release maintains full backward compatibility with v0.3.34. No breaking changes were introduced.
