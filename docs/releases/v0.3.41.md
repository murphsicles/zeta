# Zeta Compiler v0.3.41 - Package Ecosystem: Dependency Management
...
This release maintains full backward compatibility with v0.3.40. No breaking changes were introduced.
