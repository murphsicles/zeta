# Zeta Compiler v0.3.38 - Concurrency Foundation: Parallel Computing
...
Concurrency Foundation: Parallel Computing
...
This release maintains full backward compatibility with v0.3.37. No breaking changes were introduced.
