# Script to create GitHub Release for v0.3.20
# Run this from PowerShell with GitHub CLI installed and authenticated

param(
    [string]$Tag = "v0.3.20",
    [string]$Title = "Zeta v0.3.20 - The Discipline Release",
    [string]$NotesFile = "docs/RELEASE_v0.3.20.md"
)
...
try {
    ...
    Write-Host "📝 View at: https://github.com/murphsicles/zeta/releases/tag/$Tag"
