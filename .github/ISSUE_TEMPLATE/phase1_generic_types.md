---
name: Phase 1 - Generic Type Support
about: Extend v0.3.7 to parse generic types (`lt(Result, i64)`)
title: 'Phase 1: Generic Type Support - Parse `lt(Result, i64)`'
labels: ['enhancement', 'parser', 'bootstrap']
assignees: ''
---
