...
fn main() {
    ...
    let test_files = [
        "tests/comptime-completion/test_var_create.z",
        "tests/comptime-completion/test_trace.z",
        "tests/comptime-completion/test_one_iteration.z",
        "tests/comptime-completion/test_one_iteration_i1.z",
        "tests/comptime-completion/test_direct_for.z",
    ];
