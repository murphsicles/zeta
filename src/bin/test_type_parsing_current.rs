...
fn main() {
    ...
    println!("4. Result<i32, String>: {:?}", Type::from_string("Result<i32, String>"));
    
    // Test nested generics
    println!("5. Vec<Vec<i32>>: {:?}", Type::from_string("Vec<Vec<i32>>"));
    
    // Test complex generic with tuple
    println!("6. HashMap<(String, String), Vec<AstNode>>: {:?}", 
             Type::from_string("HashMap<(String, String), Vec<AstNode>>"));
    
    // Test trait object
    println!("7. Box<dyn std::error::Error>: {:?}", 
    ...
    println!("10. std::collections::HashMap<String, i32>: {:?}", 
