...
pub fn legacy_evaluate_constants(
    asts: &[crate::frontend::ast::AstNode],
) -> Result<Vec<crate::frontend::ast::AstNode>, String> {
...
impl LegacyCompatConstEvaluator {
    ...
    pub fn eval_const_expr(
        &mut self,
        expr: &crate::frontend::ast::AstNode,
