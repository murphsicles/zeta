...
impl AssociatedTypeContext {
    ...
    pub fn add_definition(&mut self, trait_name: String, assoc_type: AssociatedType) {
        self.definitions
            .insert((trait_name, assoc_type.name.clone()), assoc_type);
    }
    ...
    pub fn add_implementation(
        ...
        self.implementations
            .insert((impl_type, trait_name, assoc_name), concrete_type);
    }
    ...
    pub fn normalize_projection(
        ...
        Ok(Type::Named(
            format!(
                "{}::{}",
                projection.base.display_name(),
                projection.assoc_name
            ),
    ...
    pub fn check_bound(&self, ty: &Type, bound: &AssocTraitBound) -> Result<(), String> {
        match bound {
...
mod tests {
    ...
    fn test_trait_bound_display() {
        ...
        let bound = AssocTraitBound::Trait("Iterator".to_string(), vec![Type::I32]);
