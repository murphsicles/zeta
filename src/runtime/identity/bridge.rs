...
impl IdentityRuntimeManager {
    ...
    pub fn validate_string_operation(
        ...
        let required_capability = match operation {
            ...
            | "lines" | "matches" | "rmatches" | "escape_debug" | "escape_default" | "len"
            | "is_empty" | "contains" | "starts_with" | "ends_with" => CapabilityLevel::Read,
        ...
        self.context
            .validator()
            .check_capability(required_capability)?;
    ...
    pub fn manager(&mut self) -> &mut IdentityRuntimeManager {
        if self.manager.is_none() {
            ...
            let default_identity =
                IdentityType::with_value("anonymous".to_string(), vec![CapabilityLevel::Read]);
...
mod tests {
    ...
    fn test_identity_runtime_manager() {
        ...
        assert!(
            manager
                .validate_string_operation("concat", "hello", &["world"])
                .is_ok()
        );
        ...
        assert!(
            manager
                .validate_string_operation("trim_start", "  hello", &[])
                .is_ok()
        );
        ...
        assert!(
            manager
                .validate_string_operation("into_bytes", "hello", &[])
                .is_err()
        );
    }
    ...
    fn test_execute_string_operation() {
        ...
        let result =
            manager.execute_string_operation("concat", "hello", &["world"], |input, args| {
                format!("{}{}", input, args[0])
            });
    ...
    fn test_global_identity_runtime() {
        ...
        assert_eq!(
            manager.context().validator().capability_level(),
