...
use super::nn::{BatchNorm2d, Conv2d, Dense, Dropout, LSTM, Layer, RNN, Sequential};
...
impl RNNModel {
    ...
    pub fn new(
        ...
        // RNN layer
        layers = layers.add(RNN::new(input_size, hidden_size, num_layers, "tanh"));
    ...
    pub fn lstm(
        ...
        layers = layers.add(LSTM::new(input_size, hidden_size, num_layers));
...
impl Autoencoder {
    ...
    pub fn new(input_size: usize, hidden_sizes: Vec<usize>, latent_dim: usize) -> Self {
        // Build encoder
