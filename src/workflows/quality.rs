...
impl QualityIssue {
    ...
    pub fn new(issue_type: &str, severity: IssueSeverity, file: &str, message: &str) -> Self {
        Self {
...
pub fn check_code_quality(
    ...
    for severity in &[
        ...
        let severity_issues: Vec<_> = sorted_issues
            .iter()
    ...
    println!(
        "Code quality check completed. Found {} issues.",
        issues.len()
    );
