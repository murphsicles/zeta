...
pub enum AstNode {
    ...
    FuncDef { name: String, generics: Vec<String>, params: Vec<(String, String)>, ret: String, body: Vec<AstNode>, where_clause: Option<Vec<(String, String)>>, attrs: Vec<String>, ret_expr: Option<Box<AstNode>> },
    ...
    Call { receiver: String, method: String, args: Vec<String> },
    Lit(i64),
    Var(String),
