...
pub fn parse_assign(input: &str) -> IResult<&str, AstNode, nom::error::Error<&str>> {
...
pub fn parse_return(input: &str) -> IResult<&str, AstNode, nom::error::Error<&str>> {
    let (input, _) = ws(tag("return"))(input)?;
    let (input, inner) = ws(parse_full_expr)(input)?;
    Ok((input, AstNode::Return(Box::new(inner))))
}

pub fn parse_if(input: &str) -> IResult<&str, AstNode, nom::error::Error<&str>> {
...
pub fn parse_stmt(input: &str) -> IResult<&str, AstNode, nom::error::Error<&str>> {
