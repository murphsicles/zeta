...
use crate::blockchain::common::types::{
    Address, Amount, FeeEstimate, Network, Priority, TransactionId,
};
...
pub fn Bitcoin_Network_broadcast_transaction(
    tx_bytes: &[u8],
...
pub fn Bitcoin_Network_get_transaction_status(
    tx_id: &TransactionId,
) -> Result<crate::blockchain::common::types::TransactionStatus, BlockchainError> {
...
pub fn Bitcoin_Network_get_info()
-> Result<crate::blockchain::common::traits::NetworkInfo, BlockchainError> {
