...
Zeta v0.1.0 is released. There are zero competitors.
We're living in a brand new paradigm.

> “Complexity assersions have to be part of the interface.” - Alexander Stepanov, 1995

## Official Benchmarks — December 25, 2025  
Intel i9-13900K · Linux 6.11

| Benchmark                          | Zeta 0.1.0     | Rust 1.82     | Zig 0.13     | Go 1.23      | C++23 (clang++) | Verdict                              |
|------------------------------------|---------------|--------------|--------------|--------------|------------------|--------------------------------------|
