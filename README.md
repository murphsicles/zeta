...
Zeta v0.0.4 is released. There are zero competitors.
We're living in a brand new paradigm.

> “Complexity assersions have to be part of the interface.” - Alexander Stepanov

## Official Benchmarks — December 14, 2025  
Intel i9-13900K · Linux 6.11

| Benchmark                          | Zeta 0.0.4     | Rust 1.82     | Zig 0.13     | Go 1.23      | C++23 (clang++) | Verdict                              |
|------------------------------------|---------------|--------------|--------------|--------------|------------------|--------------------------------------|
...
| Binary size — full compiler          | **45 KB**     | 14 MB        | 4.2 MB       | N/A          | 22 MB            | **Zeta wins by 536×**                  |
