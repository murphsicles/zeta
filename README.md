...
- **Native WASM support**
- **Self-hosting in 2,900 lines of code**
- **Very low cyclomatic complexity**

Zeta v0.1.5 is released. There are zero competitors.
...
| Benchmark                          | Zeta 0.1.5     | Rust 1.82     | Zig 0.13     | Go 1.23      | C++23 (clang++) | Verdict                              |
|------------------------------------|---------------|--------------|--------------|--------------|------------------|--------------------------------------|
