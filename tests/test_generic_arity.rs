...
fn main() {
    ...
    let generic_func = Type::Function(
        vec![t_var.clone()],
        Box::new(t_var.clone()),
    );
    ...
    match substitution.instantiate_generic_with_bounds(&generic_func, &type_args, &Default::default()) {
    ...
    match substitution.instantiate_generic_with_bounds(&generic_func, &type_args_correct, &Default::default()) {
    ...
    match substitution.instantiate_generic_with_bounds(&option_t, &correct_args, &Default::default()) {
